...
font-weight: 700;border-radius:10px;" BackColor="#5EC8CD" BorderColor="#51C4C9" BorderStyle="None" ToolTip="请输入邮箱验证码"></asp:TextBox>
            ...
            <asp:Button ID="Button2" runat="server" BackColor="#51C4C9" BorderColor="#53C5C9" BorderStyle="None" OnClick="Button2_Click" style="z-index: 1;  left: 65%; top: 63%; position: absolute; height: 34px; width: 76px; text-decoration: underline; font-size: 14pt; font-family: 楷体;" Text="上一步" Visible="False" />
            ...
            <asp:Button ID="Button5" runat="server" style="z-index: 1; left: 65%; top: 63%; position: absolute; height: 58px; width: 103px; font-size: 14pt; font-family: 楷体; text-decoration: underline;" BackColor="#5BC7CC" BorderColor="#52C5CA" BorderStyle="None" OnClick="Button5_Click"  Text="返回" />
            ...
            <asp:Label ID="Label6" runat="server" style="z-index: 1; left: 82%; top: 39%; position: absolute;color: #FF0000; font-size: 14pt; font-family: 楷体;">1</asp:Label>
            <asp:Label ID="Label7" runat="server" style="z-index: 1; left: 82%; top: 51%; position: absolute;color: #FF0000; font-size: 14pt; font-family: 楷体;">1</asp:Label>
            <asp:Label ID="Label8" runat="server" style="z-index: 1; left: 49%; top: 77%; position: absolute;color: #FF0000; font-size: 14pt; font-family: 楷体;">1</asp:Label>
